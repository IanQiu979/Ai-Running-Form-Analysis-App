...
- **The Cadence Arcs redesign is unmerged** — `redesign/cadence-arcs-2026-09-01` carries the whole
  visual system (tokens, arc primitives, the ring readout, launch assets) and has not been merged
  to `main`. Until it is, `main` still ships the 2026-08-02 Calm design system, and every
  screenshot, icon and splash asset in a build comes from that older system. See the M7 row above
  and `docs/change_log.md`'s 2026-09-01 entries.

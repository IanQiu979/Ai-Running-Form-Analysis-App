...
36. **NEW — Free tier's zero-model-call sample preview (captain-approved 2026-07-26) has no
    ...
    **SUPERSEDED 2026-09-06 (code-complete, not yet deployed) — see Known Issue #42.** The
    ...
    era; it is no longer current once #42 deploys.
...
42. **NEW — Free tier's fabricated zero-model-call sample (Known Issues #36/#37 above) is
...
- **Known Issue #42** — the Free-tier real-analysis rewrite of `analyze-form` is code-complete
  with focused regression coverage but **not deployed**. `analyze-form` needs

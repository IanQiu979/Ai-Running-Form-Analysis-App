...
// factory over Deno globals that only exist at edge-function runtime. #44 should add its own
// Deno-side check (`deno check supabase/functions/**/*.ts`) since this deliberately isn't it.
//
